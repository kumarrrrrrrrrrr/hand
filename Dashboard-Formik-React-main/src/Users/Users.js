...
export default function Users(){
    ...
    useEffect(async ()=> {
        let users = await fetch("https://6309b19ff8a20183f7756402.mockapi.io/users");
    ...
    async function deleteData(id){
        await fetch(`https://6309b19ff8a20183f7756402.mockapi.io/users/${id}`,{
            method: "DELETE",
            body: null,
            headers: {
...
<Link className="btn btn-primary m-3" to="/userscreate">Create User</Link>
